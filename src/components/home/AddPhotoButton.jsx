const AddPhotoButton = () => {
    return ( 
        <div>
            <div className="d-flex align-items-center justify-content-center add_photo_button_container">
            <button className="btn" type="button" data-bs-toggle="modal" data-bs-target="#addPhotoModal">
